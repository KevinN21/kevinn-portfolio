...
<html>
    ...
    <body data-spy="scroll" data-target="#k-navbar">
        <header id="k-header" class=" text-center">
            <nav class="k-navbar navbar navbar-default" id="k-navbar">
        ...
        <main class="container-fluid">
            <div class="scrollbutton">
                <a class="prev scroll-to" href="#"><i class="glyphicon glyphicon-chevron-up" alt=""></i></a>
                <a class="next" href="#"><i class="glyphicon glyphicon-chevron-down" alt="down"></i></a>
            </div>
            <section id="k-abtme"    class="row text-center panel current-panel">
            ...
            <section id="k-works"    class="row text-center panel">
                <article class="row">
            ...
            <section id="k-showcase" class="row panel">
                <article class="row">
            ...
            <section id="k-skills"   class="row panel">
              <div class="row">
            ...
            <section id="k-contact"  class="row text-center panel">
